...
class Node:
    ...
    def __init__(self, state, parent=None, action=None, path_cost=0, heuristic=None):
        # type: (object, object, object, object, object) -> object
        """Create a search tree Node, derived from a parent by an action."""
        update(self, state=state, parent=parent, action=action,
               path_cost=path_cost,  heuristic=heuristic, depth=0)
        if parent:
    ...
    def __repr__(self):
        ...
        return '<Node %s -Cost %s -Heuristic %s>' % (self.state,self.path_cost, self.heuristic)
